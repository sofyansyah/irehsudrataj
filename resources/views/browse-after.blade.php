...
<ul class="nav navbar-nav navbar-left">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><div class="dropdown">
                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="padding:15px 0 15px 15px;">
        ...
        <div class="row">
          <div class="col-md-12 text-left">
            <div class="col-md-12 content-idea">
              ...
              <br/>
              <p style="font-size: 18px;color: #dd5f4c;">
